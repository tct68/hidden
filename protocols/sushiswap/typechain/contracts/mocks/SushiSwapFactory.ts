...
export interface SushiSwapFactoryInterface extends utils.Interface {
  functions: {
...
export interface SushiSwapFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SushiSwapFactoryInterface;
