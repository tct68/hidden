...
export interface RouteProcessor3Interface extends utils.Interface {
  functions: {
...
export interface RouteProcessor3 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RouteProcessor3Interface;
