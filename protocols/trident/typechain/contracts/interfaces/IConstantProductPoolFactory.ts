...
export interface IConstantProductPoolFactoryInterface extends utils.Interface {
  functions: {
...
export interface IConstantProductPoolFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IConstantProductPoolFactoryInterface;
