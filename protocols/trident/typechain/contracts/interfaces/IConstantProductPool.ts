...
export interface IConstantProductPoolInterface extends utils.Interface {
  functions: {
...
export interface IConstantProductPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IConstantProductPoolInterface;
