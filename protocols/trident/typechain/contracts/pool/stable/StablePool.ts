...
export interface StablePoolInterface extends utils.Interface {
  functions: {
    ...
    "decimals0()": FunctionFragment;
    "decimals1()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "decimals0", values?: undefined): string;
  encodeFunctionData(functionFragment: "decimals1", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "decimals0", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "decimals1", data: BytesLike): Result;
...
export interface StablePool extends BaseContract {
  ...
  functions: {
    ...
    decimals0(overrides?: CallOverrides): Promise<[BigNumber]>;

    decimals1(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    decimals0(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    decimals1(overrides?: CallOverrides): Promise<PopulatedTransaction>;
